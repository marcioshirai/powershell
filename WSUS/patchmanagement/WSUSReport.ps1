...
$EmailParams = @{
    ...
    Subject = "$WSUSServer ($port) WSUS Report"
...
$HTMLParams = @{
    ...
    PreContent = "<H1><font color='white'>Please view in html!</font><br>$WSUSServer ($port) WSUS Report</H1>"
...
$metric3 = ("461cc027-f4d8-453b-baac-c99a73fb0032.windows.totalspace " + [int]$(($data.Size|Convert-Size).split("GB")[0]) + " " + $epochTime)
$metric4 = ("461cc027-f4d8-453b-baac-c99a73fb0032.windows.usedspace " + $([int]($UsedSpace|Convert-Size).split("GB")[0]) + " " + $epochTime)
$metric5 = ("461cc027-f4d8-453b-baac-c99a73fb0032.windows.freespace " + [int]$(($Data.freespace|Convert-Size).split("GB")[0]) + " " + $epochTime)
$metric6 = ("461cc027-f4d8-453b-baac-c99a73fb0032.windows.percentfree " + $([int](($Data.Freespace / $Data.Size) * 100)) + " " + $epochTime)
...
$writer.WriteLine($metric5)
$writer.WriteLine($metric6)
